...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_email_field = findViewById(R.id.regEmail);
        reg_pass_field = findViewById(R.id.regPass);
        reg_confirm_pass_field = findViewById(R.id.regPassConfirm);
        reg_btn = findViewById(R.id.btn_reg);
        reg_login_btn = findViewById(R.id.btn_toLogin);
